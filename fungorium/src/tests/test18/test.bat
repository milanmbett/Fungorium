...
REM Run the Java program with parameter "--test 18" and capture output.
for /f "delims=" %%a in ('java -jar "%JAR_FILE%" --test 18 ^< "%INPUT_FILE%"') do (
    set "OUTPUT=%%a"
)
...
set "PATTERN14=GET   com.coderunnerlovagjai.app.Tecton_Class - Tecton's Spore:"
