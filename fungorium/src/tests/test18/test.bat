...
REM filepath: /home/borisz/projlab-jva/Fungorium/fungorium/src/tests/test18/test.bat

REM Get the directory of this script.
for %%I in ("%~dp0.") do set "SCRIPT_DIR=%%~fI"

REM Load global environment variables from the .env file (assumed one level above test18).
...
REM Run the Java program with parameter "--test 18" and redirect output to output.log.
java -jar "%JAR_FILE%" --test 18 < "%INPUT_FILE%" > output.log 2>&1
...
set "PATTERN7=CREATE com\.coderunnerlovagjai\.app\.Spore_Speed - Spore_Speed Created! ID: Spore_Speed0 on Tecton: Tecton_Basic0"
set "PATTERN8=ADD   com\.coderunnerlovagjai\.app\.Spore_Speed - Spore_Speed: Spore_Speed0 added to SporeCollection! SporeCollection size: 1"
...
set "PATTERN13=SET   com\.coderunnerlovagjai\.app\.Insect_Class - Insect: Insect_Buglet0 available steps set to: 4"
set "PATTERN14=GET   com\.coderunnerlovagjai\.app\.Tecton_Class - Tecton's Spore: .*Spore_Speed@"
set "PATTERN15=DIE   com\.coderunnerlovagjai\.app\.Basic_Spore - Spore: Spore_Speed0 is dead!"
set "PATTERN16=INCOME com\.coderunnerlovagjai\.app\.Player - Income increased by 100. New income: 300"
set "PATTERN17=SCORE com\.coderunnerlovagjai\.app\.Player - Score increased by 100. New score: 100"
set "PATTERN18=NULL  com\.coderunnerlovagjai\.app\.Tecton_Class - Spore is null!"
set "PATTERN19=SUCCESS com\.coderunnerlovagjai\.app\._Tests - Test ran successfully!"
