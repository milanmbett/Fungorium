#!/bin/bash
# filepath: /home/borisz/projlab-jva/Fungorium/fungorium/src/tests/test9/test.sh
...
# Run the Java program with parameter "--test 9" and capture the output.
OUTPUT=$(java -jar "$JAR_FILE" --test 9 < "$INPUT_FILE")
...
PATTERN5="Insect_Class Constructor called!"
PATTERN6="Tecton's Insects: \[\]"
PATTERN7="Tecton's ID: Tecton_Basic0"
PATTERN8="Insect_Buglet Created! ID: Insect_Buglet0 on Tecton: Tecton_Basic0"
PATTERN9="Insect_Buglet: Insect_Buglet0 added to InsectCollection! InsectCollection size: 1"
PATTERN10="Test ran successfully!"
