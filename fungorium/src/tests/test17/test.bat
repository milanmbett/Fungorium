...
REM Run the Java program with parameter "--test 17" and capture output.
for /f "delims=" %%a in ('java -jar "%JAR_FILE%" --test 17 ^< "%INPUT_FILE%"') do (
    set "OUTPUT=%%a"
)
...
set "PATTERN15=GET   com.coderunnerlovagjai.app.Tecton_Class - Tecton's Spore:"
