...
REM filepath: /home/borisz/projlab-jva/Fungorium/fungorium/src/tests/test17/test.bat

REM Get the directory of this script.
for %%I in ("%~dp0.") do set "SCRIPT_DIR=%%~fI"

REM Load global environment variables from the .env file (assumed one level above test17).
...
REM Run the Java program with parameter "--test 17" and redirect output to output.log.
java -jar "%JAR_FILE%" --test 17 < "%INPUT_FILE%" > output.log 2>&1
...
set "PATTERN5=Basic_Spore Constructor called!"
set "PATTERN6=GET   com\.coderunnerlovagjai\.app\.Tecton_Class - Tecton's ID: Tecton_Basic0"
set "PATTERN7=CREATE com\.coderunnerlovagjai\.app\.Spore_Slowing - Spore_Slowing Created! ID: Spore_Slowing0 on Tecton: Tecton_Basic0"
set "PATTERN8=ADD   com\.coderunnerlovagjai\.app\.Spore_Slowing - Spore_Slowing: Spore_Slowing0 added to SporeCollection! SporeCollection size: 1"
...
set "PATTERN13=SET   com\.coderunnerlovagjai\.app\.Insect_Class - Insect: Insect_Buglet0 attack damage set to: 50"
set "PATTERN14=SET   com\.coderunnerlovagjai\.app\.Insect_Class - Insect: Insect_Buglet0 available steps set to: 1"
set "PATTERN15=GET   com\.coderunnerlovagjai\.app\.Tecton_Class - Tecton's Spore: .*Spore_Slowing@"
set "PATTERN16=DIE   com\.coderunnerlovagjai\.app\.Basic_Spore - Spore: Spore_Slowing0 is dead!"
set "PATTERN17=INCOME com\.coderunnerlovagjai\.app\.Player - Income increased by 100. New income: 300"
set "PATTERN18=SCORE com\.coderunnerlovagjai\.app\.Player - Score increased by 100. New score: 100"
set "PATTERN19=NULL  com\.coderunnerlovagjai\.app\.Tecton_Class - Spore is null!"
