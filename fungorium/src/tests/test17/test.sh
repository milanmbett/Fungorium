#!/bin/bash
# filepath: /home/borisz/projlab-jva/Fungorium/fungorium/src/tests/test17/test.sh
...
# Run the Java program with parameter "--test 17" and capture its output.
OUTPUT=$(java -jar "$JAR_FILE" --test 17 < "$INPUT_FILE")
...
PATTERN7="CREATE com\.coderunnerlovagjai\.app\.Spore_Slowing - Spore_Slowing Created! ID: Spore_Slowing0 on Tecton: Tecton_Basic0"
PATTERN8="ADD   com\.coderunnerlovagjai\.app\.Spore_Slowing - Spore_Slowing: Spore_Slowing0 added to SporeCollection! SporeCollection size: 1"
...
PATTERN13="SET   com\.coderunnerlovagjai\.app\.Insect_Class - Insect: Insect_Buglet0 attack damage set to: 50"
PATTERN14="SET   com\.coderunnerlovagjai\.app\.Insect_Class - Insect: Insect_Buglet0 available steps set to: 1"
PATTERN15="GET   com\.coderunnerlovagjai\.app\.Tecton_Class - Tecton's Spore: .*Spore_Slowing@"
PATTERN16="DIE   com\.coderunnerlovagjai\.app\.Basic_Spore - Spore: Spore_Slowing0 is dead!"
PATTERN17="INCOME com\.coderunnerlovagjai\.app\.Player - Income increased by 100\. New income: 300"
PATTERN18="SCORE com\.coderunnerlovagjai\.app\.Player - Score increased by 100\. New score: 100"
PATTERN19="NULL  com\.coderunnerlovagjai\.app\.Tecton_Class - Spore is null!"
