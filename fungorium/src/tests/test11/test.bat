...
REM Run the Java program with parameter "--test 11" and redirect output to output.log.
java -jar "%JAR_FILE%" --test 11 < "%INPUT_FILE%" > output.log 2>&1
...
set "PATTERN10=GET   com\.coderunnerlovagjai\.app\.Tecton_Class - Tecton's Mushroom: .*Mushroom_Shroomlet"
set "PATTERN11=GET   com\.coderunnerlovagjai\.app\._Tests - Mushroom's Tecton: Tecton_Basic0"
set "PATTERN12=SUCCESS com\.coderunnerlovagjai\.app\._Tests - Test ran successfully!"

REM Check that all expected patterns exist in output.log.
