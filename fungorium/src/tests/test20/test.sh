#!/bin/bash
# filepath: /home/borisz/projlab-jva/Fungorium/fungorium/src/tests/test20/test.sh
...
# Run the Java program with parameter "--test 20" and capture its output.
OUTPUT=$(java -jar "$JAR_FILE" --test 20 < "$INPUT_FILE")
...
PATTERN12="GET   com\.coderunnerlovagjai\.app\.Tecton_Class - Tecton's ID: Tecton_Basic0"
PATTERN13="CREATE com\.coderunnerlovagjai\.app\.Insect_Buglet - Insect_Buglet Created! ID: Insect_Buglet0 on Tecton: Tecton_Basic0"
PATTERN14="ADD   com\.coderunnerlovagjai\.app\.Insect_Buglet - Insect_Buglet: Insect_Buglet0 added to InsectCollection! InsectCollection size: 1"
PATTERN15="NULL  com\.coderunnerlovagjai\.app\.Tecton_Class - Mushroom is set to null!"
PATTERN16="NULL  com\.coderunnerlovagjai\.app\.Tecton_Class - Mushroom is null!"
