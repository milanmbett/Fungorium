...
REM filepath: /home/borisz/projlab-jva/Fungorium/fungorium/src/tests/test20/test.bat

REM Get the directory of the script.
for %%I in ("%~dp0.") do set "SCRIPT_DIR=%%~fI"

REM Load global environment variables from the .env file (assumed one level above test20).
...
REM Run the Java program with parameter "--test 20" and capture output.
for /f "delims=" %%a in ('java -jar "%JAR_FILE%" --test 20 ^< "%INPUT_FILE%"') do (
    set "OUTPUT=%%a"
)
...
set "PATTERN6=SET   com.coderunnerlovagjai.app.Tecton_Class - Tecton's Mushroom:"
...
set "PATTERN12=GET   com.coderunnerlovagjai.app.Tecton_Class - Tecton's ID: Tecton_Basic0"
...
set "PATTERN15=NULL  com.coderunnerlovagjai.app.Tecton_Class - Mushroom is set to null!"
set "PATTERN16=NULL  com.coderunnerlovagjai.app.Tecton_Class - Mushroom is null!"
