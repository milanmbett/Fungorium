...
REM Run the Java program with parameter "--test 19" and capture output.
for /f "delims=" %%a in ('java -jar "%JAR_FILE%" --test 19 ^< "%INPUT_FILE%"') do (
    set "OUTPUT=%%a"
)
...
set "PATTERN17=GET   com.coderunnerlovagjai.app.Tecton_Class - Tecton's Spore: "
